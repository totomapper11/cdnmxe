...
var dvz_shoutbox = {
    ...
    toggle: function(status, remember) {
        ...
        if (status == true) {
			...
			$("#window_shoutbox").attr("src","./images/grom/collapse.png");
			...
			$("#window_shoutbox").attr("src","./images/grom/collapse_collapsed.png")
    ...
    parseEntries: function(areLatest) {
        ...
        $('#shoutbox .entry:not([data-parsed])').each(function() {
            ...
            if (typeof $(this).attr('data-mod') !== 'undefined') {
                $(this).children('.info').prepend('<a href="" class="mod edit button"><i class="fas fa-edit"></i>EDIT</a><a href="" class="mod del button"><i class="fas fa-trash"></i></a>');;
            }
...
$(document).ready(function() {
	...
	$(document).on('ready', '#shoutbox .entry .mod.edit', function() {
		dvz_shoutbox.edit( $(this).parents('.entry').attr('data-id') );
		return false;
	});
